...
<br /><br />&nbsp;&nbsp;&nbsp;
<input type="radio" name="r1" />ACCOUNT NUMBER&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="t1" /><br /><br />&nbsp;&nbsp;&nbsp;
<input type="radio" name="r2" value="1" />DATE OF BIRTH&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="date">
...
<?php
	if(isset($_POST['b1']))
	{
		...
		switch($check)
		{
			...
			if($con==true)
			{
				$cmd="select * from newuser where accountno=$acc and date=$date and month='$month' and year=$year";
				if($r=$con->query($cmd))
				{
					if($r->num_rows>0)
					{
						header('location:disableUserContinue.php');
					}
					else
					{
						?>
			...
			if($con==true)
			{
				$cmd="select * from newuser1 where accountno=$acc and panCard=$pan";
					if($r=$con->query($cmd))
					{
					if($r->num_rows>0)
					{
