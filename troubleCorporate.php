...
<img src="images/logo1.jpg" height="150" width="1350" />
...
<center><form name="f1" action="troubleCorporate.php" method="post"><input type="submit" value="Close window" name="b3" style="background-color:#FF0; color:#000; font-size:18px; font-style:italic" /></form></center>
</body>
</html>
<?php
if(isset($_POST['b3']))
